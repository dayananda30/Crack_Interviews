...
class TableData:
    ...
    def display(self):
        print(self.c.execute("""SELECT * FROM STUDENTS WHERE RollNum=4""").fetchall())
        print(self.c.execute("""SELECT * FROM STUDENTS WHERE Place LIKE '%BEN%'""").fetchall())
        print(self.c.execute("""SELECT * FROM STUDENTS WHERE RollNum IN (1,2,3)""").fetchall())
        print(self.c.execute("""SELECT * FROM STUDENTS WHERE RollNum BETWEEN 8 AND 9""").fetchall())
